...
List<Planet> planets = [
  ...
  const Planet(
      ...
      gravity: "3.711 m/s ",
      description:
          "The Moon is an astronomical body that orbits planet E+arth, being Earth's only permanent natural satellite. It is the fifth-largest natural satellite in the Solar System, and the largest among planetary satellites relative to the size of the planet that it orbits (its primary). Following Jupiter's satellite Io, the Moon is second-densest satellite among those whose densities are known.",
  ...
  const Planet(
      ...
      gravity: "27.71 m/s ",
      description: " "
          " Earth is the third planet from the Sun and the only object in the Universe known to "
          "harbor life. According to radiometric dating and other sources of evidence, Earth formed "
          "over4 billion years ago. Earth's gravity interacts with other objects in space, especiallythe "
          "Sun and the Moon, Earth's only natural satellite. Earth revolves around the Sun in365.26 days, "
          "a period known as an Earth year. During this time, Earth rotates about its axis about 366.26 times.",
